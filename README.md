...
- Last build (UTC): `2026-05-08T01:39:25+00:00`
...
- Fast chargers with static AFIR details: `9453` (price: `7676`, opening hours: `10964`)
- Chargers with >=1 nearby amenity: `15211`
- Occupancy sources scanned: `29` (matched EVSEs: `2756`)
- Static AFIR sources used: `19` (helpdesk phones: `5560`)
- Amenity backend: `osm-pbf`
