...
- Last build (UTC): `2026-06-11T01:54:18+00:00`
...
- Fast chargers with live occupancy: `1366`
- Fast chargers with static AFIR details: `9959` (price: `8139`, opening hours: `11252`)
- Chargers with >=1 nearby amenity: `15460`
- Occupancy sources scanned: `28` (matched EVSEs: `5628`)
- Static AFIR sources used: `22` (helpdesk phones: `5711`)
- Amenity backend: `osm-pbf`
