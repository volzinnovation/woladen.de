...
- Last build (UTC): `2026-06-02T01:53:35+00:00`
...
- Fast chargers with static AFIR details: `9727` (price: `8000`, opening hours: `11039`)
- Chargers with >=1 nearby amenity: `15214`
- Occupancy sources scanned: `29` (matched EVSEs: `2325`)
- Static AFIR sources used: `20` (helpdesk phones: `5576`)
- Amenity backend: `osm-pbf`
