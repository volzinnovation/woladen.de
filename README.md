...
- Last build (UTC): `2026-04-30T01:38:49+00:00`
...
- Fast chargers with static AFIR details: `9393` (price: `7624`, opening hours: `10941`)
- Chargers with >=1 nearby amenity: `15214`
- Occupancy sources scanned: `27` (matched EVSEs: `2762`)
- Static AFIR sources used: `19` (helpdesk phones: `5517`)
- Amenity backend: `osm-pbf`
