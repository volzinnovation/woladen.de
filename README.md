...
- Last build (UTC): `2026-05-31T01:46:10+00:00`
...
- Fast chargers with static AFIR details: `9727` (price: `7999`, opening hours: `11037`)
- Chargers with >=1 nearby amenity: `15214`
- Occupancy sources scanned: `30` (matched EVSEs: `2383`)
- Static AFIR sources used: `20` (helpdesk phones: `5574`)
- Amenity backend: `osm-pbf`
