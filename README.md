...
- Last build (UTC): `2026-06-19T02:00:19+00:00`
...
- Fast chargers with live occupancy: `1346`
- Fast chargers with static AFIR details: `10000` (price: `8252`, opening hours: `11222`)
- Chargers with >=1 nearby amenity: `15462`
- Occupancy sources scanned: `29` (matched EVSEs: `5552`)
- Static AFIR sources used: `23` (helpdesk phones: `5746`)
- Amenity backend: `osm-pbf`
