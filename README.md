...
- Last build (UTC): `2026-04-29T01:39:13+00:00`
...
- Fast chargers with static AFIR details: `9205` (price: `7436`, opening hours: `10846`)
- Chargers with >=1 nearby amenity: `15214`
- Occupancy sources scanned: `27` (matched EVSEs: `2794`)
- Static AFIR sources used: `19` (helpdesk phones: `5312`)
- Amenity backend: `osm-pbf`
