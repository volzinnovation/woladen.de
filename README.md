...
- Last build (UTC): `2026-06-16T01:57:09+00:00`
...
- Fast chargers with static AFIR details: `9985` (price: `8245`, opening hours: `11258`)
- Chargers with >=1 nearby amenity: `15462`
- Occupancy sources scanned: `29` (matched EVSEs: `5681`)
- Static AFIR sources used: `23` (helpdesk phones: `5729`)
- Amenity backend: `osm-pbf`
