const CACHE_NAME = "woladen-shell-20260717-settings1";

const APP_SHELL = [
  "/",
  "/index.html",
  "/styles.css?v=20260717-settings1",
  "/app-install-promo.js?v=20260620-eu-i18n9",
  "/pwa-register.js?v=20260701-pwa1",
  "/app.js?v=20260717-settings1",
