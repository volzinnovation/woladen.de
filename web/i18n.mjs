...
const FALLBACK_BUNDLE = {
  ...
  location: {
    idleTitle: "Find charging points near you",
    idleMessage: "Share your location to load charging points within 20 km.",
    idleAction: "Share location",
    pendingTitle: "Finding location",
    pendingMessage: "Charging points within 20 km are loading.",
    deniedTitle: "Location permission needed",
    deniedMessage: "Enable location access to load charging points within 20 km.",
    ...
    timeoutMessage: "Try again to load charging points within 20 km.",
    positionTitle: "Location could not be determined",
    positionMessage: "Try again when your browser can provide a location.",
    unknownMessage: "Please try again to load charging points within 20 km.",
    retry: "Try again",
