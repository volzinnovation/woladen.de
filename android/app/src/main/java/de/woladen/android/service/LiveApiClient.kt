...
class LiveApiClient(
    ...
    private fun parseCatalogStation(payload: JSONObject): CatalogStation {
        ...
        return CatalogStation(
            ...
            greenEnergyDisplay = payload.optNullableBoolean("green_energy_display"),
            helpdeskPhone = payload.optCleanString("helpdesk_phone"),
            priceDisplay = payload.optCleanString("price_display"),
            priceEnergyEurKwhMin = payload.optNullableDouble("price_energy_eur_kwh_min"),
            priceEnergyEurKwhMax = payload.optNullableDouble("price_energy_eur_kwh_max"),
            priceCurrency = payload.optCleanString("price_currency"),
            priceQuality = payload.optCleanString("price_quality"),
            serviceSupport = payload.optCleanString("service_support"),
            supportsBankCard = payload.optNullableBoolean("supports_bank_card"),
            supportsContactlessCard = payload.optNullableBoolean("supports_contactless_card"),
            supportsAdhocPayment = payload.optCleanString("supports_adhoc_payment"),
            paymentProviders = payload.optCleanString("payment_providers"),
            supportsContractPayment = payload.optNullableBoolean("supports_contract_payment"),
