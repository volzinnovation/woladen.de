    ...
    private fun catalogStationToFeature(
        ...
        return GeoJsonFeature(
            ...
            properties = ChargerProperties(
                ...
                priceEnergyEurKwhMin = station.priceEnergyEurKwhMin,
                priceEnergyEurKwhMax = station.priceEnergyEurKwhMax,
                priceCurrency = station.priceCurrency,
                priceQuality = station.priceQuality,
                ...
                paymentMethodsDisplay = listOf(
                    station.paymentMethods,
                    station.paymentProviders,
                    station.supportsAdhocPayment
                ...
                greenEnergy = station.greenEnergy ?: station.greenEnergyDisplay,
                serviceTypesDisplay = station.serviceSupport,
                detailsJson = "",
