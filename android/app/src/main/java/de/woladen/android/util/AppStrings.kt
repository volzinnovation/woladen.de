...
object AppStrings {
    ...
    private fun fallback(@StringRes id: Int): String {
        return when (id) {
            ...
            R.string.i18n_amenity_open -> "Open now"
            R.string.i18n_amenity_closed -> "Closed"
            R.string.i18n_amenity_opening_closes_at -> "Closes at {time}"
            R.string.i18n_amenity_opening_opens_at -> "Opens at {time}"
            R.string.i18n_amenity_opening_closes_on_at -> "Closes {day} at {time}"
            R.string.i18n_amenity_opening_opens_on_at -> "Opens {day} at {time}"
